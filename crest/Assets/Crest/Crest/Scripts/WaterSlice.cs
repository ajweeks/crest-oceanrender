...
namespace Crest
{
    public class WaterSlice : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _rend.sortingOrder = -LodDataMgr.MAX_LOD_COUNT - 1;
            int horizDivisions = Mathf.CeilToInt(transform.localScale.x / 16.0f);
            GetComponent<MeshFilter>().mesh = Mesh2DGrid(0, 2, -0.5f, -0.5f, 1f, 1f, horizDivisions, 1);
            Debug.Log(horizDivisions);
