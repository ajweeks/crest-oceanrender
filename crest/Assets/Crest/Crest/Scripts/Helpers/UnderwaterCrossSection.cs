...
namespace Crest
{
    ...
    /// not close to water.
    /// </summary>
    public class UnderwaterCrossSection : MonoBehaviour
    {
        ...
        const int GEOM_HORIZ_DIVISIONS = 512;
        ...
        private void Start()
        {
            ...
            GetComponent<MeshFilter>().mesh = Mesh2DGrid(0, 2, -0.5f, -0.5f, 8f, 32f, GEOM_HORIZ_DIVISIONS, 1);
